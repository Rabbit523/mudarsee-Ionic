...
@Component({
  selector: 'page-tutor-profile-information',
  templateUrl: 'tutor-profile-information.html',
  providers: [HttpService, GlobalMethods, ServiceName, ValidationService]
})
export class TutorProfileInformationPage {
  ...
  constructor(public navCtrl: NavController,
    ...
    this.profileDetailsForm = formBuilder.group({
      ...
      ownVehicle: [''],
      teaching_experience: ['', Validators.compose([Validators.required])],
      duration_of_experience: [''],
      experience_desc: ['', Validators.compose([Validators.required])]
    });
    this.user = {
